                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body p-0">
                            <div class="card-p mb-10">
                                ...
                                <div class="mb-10">
                                    <label for="exampleFormControlInput1" class="required form-label">Telefon</label>
                                    <input type="text" name="phone" value="{{$system->phone}}" class="form-control form-control-solid"
                                           placeholder="Telefon"/>
                                </div>

                                <div class="mb-10">
                                    <label for="exampleFormControlInput1" class="required form-label">E Posta</label>
                                    <input type="text" name="email" value="{{$system->email}}" class="form-control form-control-solid"
                                           placeholder="E posta"/>
                                </div>

                                <div class="mb-10">
                                    <label for="exampleFormControlInput1" class="required form-label">Çalışma Saatleri</label>
                                    <input type="text" name="working_hours" value="{{$system->working_hours}}" class="form-control form-control-solid"
